            ...
            1000x1000px JPEG, PNG Image
               ...
               Clique para remover ou reverter
                            ...
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <input class="input" type="text" placeholder="Codigo do Bling" value=""/>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                <label class="form-label max-w-56">
                                    Razão social
                                </label>
                                <input class="input" placeholder="Razão social" type="text" value=""/>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                <label class="form-label max-w-56">
                                    Email
                            ...
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <input class="input" placeholder="Cep" type="text" value=""/>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                <label class="form-label max-w-56">
                                    Endereço
                                </label>
                                <input class="input" placeholder="Endereço" type="text" value=""/>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5 mb-2.5">
                                <label class="form-label max-w-56">
                                    Número
                                </label>
                                <input class="input" placeholder="Número" type="text" value=""/>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5 mb-2.5">
                                <label class="form-label max-w-56">
                                    Cidade
                                </label>
                                <input class="input" placeholder="Cidade" type="text" value=""/>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5 mb-2.5">
                                <label class="form-label max-w-56">
                                    Estado
                                </label>
                                <input class="input" placeholder="Estado" type="text" value=""/>
                            </div>
