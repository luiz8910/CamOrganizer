...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Este código é válido por <strong>60 minutos</strong>.</p>
            <p class="warning">Se você não solicitou esta redefinição de senha, ignore este e-mail. Sua senha permanecerá inalterada.</p>
        </div>
        <div class="footer">
